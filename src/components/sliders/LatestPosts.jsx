        ...
        <>
			...
			<section className="app-section app-section-bg gap-top-140 gap-bottom-140">
				<div className="container">
					...
					{/* Blog swiper */}
					<div className="app-blog-carousel">
                        <Swiper
                        ...
                        >       
                            ...
                            <SwiperSlide key={`bs-slide-${key}`} className="swiper-slide" data-swiper-autoplay>
                                <div className="app-blog-slide-item">
                            ...
                            <div className="app-navs">
                                <div className="app-navs-box js-blog-carousel-navs">
                                    <div className="app-prev js-blog-carousel-prev app-hover-2">
                                        <i />
                                    </div>
                                    <div className="app-paginations-container">
                                        <div className="app-paginations js-blog-pagination" />
                                        <div className="swiper-nav-active" />
                                    </div>
                                    <div className="app-next js-blog-carousel-next app-hover-2">
                                        <i />
                                    </div>
                                </div>
                            </div>
