...
const Footer2 = () => {
  ...
  return (
    <>
        {/* Footer */}
        <footer className="app-footer footer--white">
				...
				<div className="container">
					...
					<div className="row gap-bottom-40">
						<div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div className="app-heading">
								...
								<p><Link href="/contact" className="app-footer-lnk app-lnk lnk--revert">Lets Start Project</Link></p>
							</div>
					...
					<div className="row gap-bottom-40">
						<div className="col-xs-12 col-sm-12 col-md-6 col-lg-2">
							...
							{/* Logo */}
							<div className="app-f-logo gap-bottom-40" style={{"maxWidth": "70px"}}>
								<Link href="/">
								...
								<ul className="app-footer-menu">
									<li>
										<Link href="/services/service-1">
											<span className="app-lnk">Branding &#038; logo</span>
										</Link>
									</li>
									<li>
										<Link href="/services/service-2">
											<span className="app-lnk">Web design</span>
										</Link>
									</li>
									<li>
										<Link href="/services/service-3">
											<span className="app-lnk">Development Services</span>
										</Link>
									</li>
									<li>
										<Link href="/blog">
											<span className="app-lnk">Publications</span>
										</Link>
									</li>
								</ul>
							</div>
						...
						<div className="col-xs-12 col-sm-12 col-md-6 col-lg-2">
							...
							<div className="app-text">
								...
								<p>
									<a className="app-lnk" href="tel:+4402074302973" target="blank">+44 (0) 20 7430 2973</a>
									<br />
									<a className="app-lnk" href="mailto:username@domain.com" target="blank">username@domain.com</a>
								</p>
							</div>
