...
const PostsDetail = ( props ) => {
  ...
  return (
    <Layouts>
      ...
      {/*  Blog Detail */}
			<section className="app-section app-post gap-top-140">
				<div className="container">

					{/* Image */}
					<div className="app-post-pic" data-app-overlay data-app-scroll>
                  ...
                  <>
                    ...
                    <div dangerouslySetInnerHTML={{ __html: postData.additional.content }} />
							...
							{/* Info */}
							<div className="app-post-bottom">
								<div className="app-post-bottom-content">

									{/* Categories */}
									<div className="app-post-categories app-lnk lnk--white">
										<span>Posted in: </span>
                  ...
                  {next_id != 0 && next_id != undefined &&
					...
					{/* Post Comments */}
					<div className="app-post-comments">
