...
const Blog2 = ( { posts, totalPosts, currentPage } ) => {
  return (
    <Layouts>
      ...
      {/*  Blog List */}
			<div className="app-blog app-archive gap-top-140">
				<div className="container">
					<div className="row archive-row">
						<div className="col-lg-8">

              {posts.map((item, key) => (
							<div className="app-blog-item archive-item" key={`post-${key}`}>
                    ...
                    {item.category}
                      ...
                      {item.short} <br />
							...
							<div className="pager">
								...
								<a className="next page-numbers app-next app-hover-2" href="#" onClick={(e) => {e.preventDefault();}}><i className="icon-arrow" /></a>
							</div>
