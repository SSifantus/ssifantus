			...
			<div className="container">
				<div className="row">
					...
					{postData.additional.enabled == 1 &&
						<div className="app-text gap-top-50">
					...
					<div className="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						...
						{/* Service menu */}
						<div className="app-service-item app-service-no-icon gap-bottom-40">
							<div className="app-service-item-inner app-hover-3 app-hover-black">
								<h5 className="title">
									<span data-splitting data-app-scroll> Services List </span>
								</h5>
								<div className="list">
									<ul>
										{services.map((item, key) => (
										<li key={`services-item-${key}`}>
											<a className="app-lnk" href={`/services/${item.id}`}>
						...
						{/*  Form */}
						<div className="app-form-box app-text-white">
							...
							<form onSubmit={handleSubmit} id="contactForm" action={appData.settings.formspreeURL} className="cform" method="post">
								<div className="row">
									...
									<div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<p>
											<button type="submit" className="app-btn app-hover-btn btn--active">
